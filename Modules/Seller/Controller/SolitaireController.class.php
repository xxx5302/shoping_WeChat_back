...
class SolitaireController extends CommonController{
	...
	public function add()
	{
        ...
        if (!empty($id)) {
			...
			$sql = "select g.id as gid, g.goodsname  from ".C('DB_PREFIX')."lionfish_comshop_solitaire_goods as gs  left join ".C('DB_PREFIX')."lionfish_comshop_goods  as g on gs.goods_id = g.id where gs.soli_id={$id}";
