...
use Seller\Model\FissionbonusModel;
use Admin\Model\GoodsModel;
class FissionbonusController extends CommonController{
	
	protected function _initialize(){
		parent::_initialize();
		$this->breadcrumb1='营销活动';
		$this->breadcrumb2='裂变红包';
	...
	public function sub_pin()
	{
		...
		**/
	    ...
	    foreach($data['goods_ids_arr'] as $goods_data)
	    {
			...
			/**
				CREATE TABLE IF NOT EXISTS `oscshop_intgral_goods` (
