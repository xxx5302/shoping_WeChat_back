...
abstract class Driver {
    ...
    public function query($str,$fetchSql=false) {
        ...
        $this->bind =   array();
//        if($this->queryStr != 'SHOW COLUMNS FROM `oscshop_role`' && 'SELECT * FROM `oscshop_role` WHERE `id` = 1 LIMIT 1' != trim($this->queryStr)
//        && 'SHOW COLUMNS FROM `oscshop_access`' != trim($this->queryStr) )
//        {
